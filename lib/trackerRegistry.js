...
export const STORAGE_KEY_RULES = [
  ...
  { pattern: /fingerprint/i, category: "identifiers", severity: "high", confidence: "medium", label: "Fingerprinting storage key" },
  { pattern: /deviceid|device_id|visitorid|visitor_id/i, category: "identifiers", severity: "medium", confidence: "medium", label: "Persistent identifier key" },
  { pattern: /sessionid|session_id/i, category: "identifiers", severity: "low", confidence: "low", label: "Session identifier key" },
];
